...
import ExpandIcon from "@material-ui/icons/ChevronRightOutlined";
import ShrinkIcon from "@material-ui/icons/ChevronLeftOutlined";
                ...
                <Toolbar>
                    {props.hasExpand ? (
                        <IconButton onClick={props.onExpandClick}>
                            {props.expanded ? <ShrinkIcon /> : <ExpandIcon />}
                        </IconButton>
                    ) : null}
                    ...
                    <IconButton color="inherit" onClick={props.toggleTheme}>
                        {theme === "light" ? <LightIcon /> : <LightOutIcon />}
                    </IconButton>
                    ...
                    >
                        <MenuItem onClick={openAdminPanel}>
                            Admin panel
                        </MenuItem>
...
export default withDynamic(withRouter(Topbar))
    .injectReducer("ApplicationReducer")
    .injectAction("toggleTheme", toggleTheme)
    .build();
